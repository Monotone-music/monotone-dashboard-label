...
import { approveAudio, AudioRequest, getAudioRequests, rejectAudio } from "@/service/audioApproveService";
...
const AudioApprovalPage = () => {
    ...
    return (
        <div className="container mx-auto p-6">
            <h1 className="text-2xl font-bold mb-6">Artist's Audio Approval Requests</h1>
                                    ...
                                    <div key={request._id} className="space-y-6">
                                        ...
                                        <div className="space-y-4">
                                            <audio ref={audioRef} controls className="w-full">
                                                <source src={`https://api2.ibarakoi.online/tracks/stream/${request._id}?bitrate=lossless`} />
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <p className="text-gray-500">
                                                    Duration: {formatDuration(request.media.fingerprint.duration)}
                                                </p>
                                            </div>
